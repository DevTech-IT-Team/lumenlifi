...
const KIT_COMPONENTS = [
  ...
  },
  {
    ...
    benefits: ['Fast throughput', 'Sub-2 ms latency', 'Multi-antenna sync'],
...
function Hotspot({ x, y, label, active, highlighted, onSelect, onHover, onLeave }) {
  return (
    ...
    >
      ...
      <motion.span
        className={`relative flex items-center justify-center rounded-full border-2 shadow-lg transition-colors ${active || highlighted
            ...
            {KIT_COMPONENTS.map((item, idx) => {
              ...
              return (
                <motion.button
                  ...
                  className={`relative w-full text-left p-4 rounded-2xl border transition-colors overflow-hidden ${glass} ${isActive
                ...
                >
                  ...
                  <div className="relative flex items-start gap-3">
                    <div
                      className={`flex-shrink-0 w-9 h-9 rounded-xl flex items-center justify-center text-sm font-black ${isActive
          ...
          <div className="relative hidden sm:flex items-center justify-between px-4 max-w-3xl mx-auto">
            ...
            {TIMELINE.map((stage, idx) => {
              ...
              return (
                ...
                >
                  <motion.span
                    className={`w-3 h-3 rounded-full border-2 transition-colors ${lit
                  ...
                  />
                  <span
                    className={`text-[9px] font-mono font-bold uppercase tracking-wide ${lit ? 'text-[#1A6EBF]' : 'text-slate-400'
                      }`}
                  >
                    {stage.label}
                  </span>
            ...
            {TIMELINE.map((stage, idx) => {
              ...
              return (
                <motion.button
                  ...
                  type="button"
                  onClick={() => setActiveId(stage.id)}
                  className={`text-left p-4 rounded-2xl border transition-all ${glass} ${isCurrent
